...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase DB1) {
        ...
        DB1.execSQL("create table Contact(conId integer primary key,conName Text,conEmail Text,conPhoneNo Text,Message Text)");
    }
    ...
    public boolean insertContact(String con_name,String con_email,String con_phone,String message){
        SQLiteDatabase conDb=getWritableDatabase();
